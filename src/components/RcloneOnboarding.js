        ...
        <div style={{
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            <h1 style={{
              ...
              {t(`rclone.onboarding.steps.${meta.id}.title`)}
            </h1>
            ...
            <p style={{
              ...
              <TypedText 
                text={t(`rclone.onboarding.steps.${meta.id}.description`)} 
                speed={15}
                delay={300}
              />
            </p>
          ...
          <div style={{
            ...
            {[
              { icon: Cloud, title: 'Cloud Remotes', desc: 'Connect Google Drive, S3, Dropbox, and 40+ providers' },
              { icon: RefreshCw, title: 'Sync & Backup', desc: 'Schedule automated sync jobs with retention policies' },
              { icon: FolderOpen, title: 'Browse Files', desc: 'Navigate cloud storage like a local filesystem' },
              { icon: Play, title: 'Scheduled Jobs', desc: 'Set up cron-based backup schedules' },
            ].map((feature, i) => (
              <div
                key={i}
                style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            {t(`rclone.onboarding.steps.${meta.id}.description`)}
          </p>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{
                ...
                <span style={{
                  ...
                  {t('rclone.onboarding.stepOf', { step: contentStep, total: contentTotal })}
                </span>
              </div>
              ...
              <p style={{
                ...
                <TypedText text={t(`rclone.onboarding.steps.${meta.id}.description`)} speed={10} delay={100} />
              </p>
              ...
              {meta.hasTip && (
                <div style={{
                  ...
                  <span style={{ fontSize: 13, color: '#94a3b8', lineHeight: 1.5 }}>
                    {t(`rclone.onboarding.steps.${meta.id}.tip`)}
                  </span>
                </div>
              )}
            </div>
...
export default function RcloneOnboarding({ onComplete }) {
  const { t } = useTranslation();
...
// Helper functions
export function hasCompletedRcloneOnboarding() {
  if (typeof window === 'undefined') return false;
  return localStorage.getItem(STORAGE_KEY) === 'true';
}

export function resetRcloneOnboarding() {
