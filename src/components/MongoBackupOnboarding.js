        ...
        <div style={{
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            <h1 style={{
              ...
              {t(`mongoBackup.onboarding.steps.${meta.id}.title`)}
            </h1>
            ...
            <p style={{
              ...
              <TypedText 
                text={t(`mongoBackup.onboarding.steps.${meta.id}.description`)} 
                speed={15}
                delay={300}
              />
            </p>
          ...
          <div style={{
            ...
            {[
              { icon: Database, title: 'MongoDB Dump', desc: 'Create compressed backups with mongodump' },
              { icon: Cloud, title: 'Cloud Storage', desc: 'Upload backups to Google Drive via Rclone' },
              { icon: RefreshCw, title: 'Scheduled Jobs', desc: 'Automate backups with cron schedules' },
              { icon: Download, title: 'Easy Restore', desc: 'Restore from any backup with one click' },
            ].map((feature, i) => (
              <div
                key={i}
                style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            {t(`mongoBackup.onboarding.steps.${meta.id}.description`)}
          </p>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{
                ...
                <span style={{
                  ...
                  {t('mongoBackup.onboarding.stepOf', { step: contentStep, total: contentTotal })}
                </span>
              </div>
              ...
              <p style={{
                ...
                <TypedText text={t(`mongoBackup.onboarding.steps.${meta.id}.description`)} speed={10} delay={100} />
              </p>
              ...
              {meta.hasTip && (
                <div style={{
                  ...
                  <span style={{ fontSize: 13, color: '#94a3b8', lineHeight: 1.5 }}>
                    {t(`mongoBackup.onboarding.steps.${meta.id}.tip`)}
                  </span>
                </div>
              )}
            </div>
...
export default function MongoBackupOnboarding({ onComplete }) {
  const { t } = useTranslation();
...
// Helper functions
export function hasCompletedMongoBackupOnboarding() {
  if (typeof window === 'undefined') return false;
  return localStorage.getItem(STORAGE_KEY) === 'true';
}

export function resetMongoBackupOnboarding() {
